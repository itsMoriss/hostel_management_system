...
class SignIn(UserCacheMixin, forms.Form):
    password = forms.CharField(label=_('Password'), strip=False, widget=forms.PasswordInput({'placeholder':'********','autocomplete': 'off','data-toggle': 'password','class':'form-control'}))
...
class SignUpForm(UserCreationForm):
    class Meta:
        ...
        # widget = {
        # 'password':forms.TextInput(attrs={'class': 'mb-2'})
        # }
    email = forms.EmailField(label=_('Email'))
